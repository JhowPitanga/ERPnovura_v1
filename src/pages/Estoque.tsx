...
import { Warehouse, Bell, Users, FilePlus2, Filter, Info, MoreHorizontal, AlertTriangle, Truck, Mail } from "lucide-react";
...
export default function Estoque() {
  ...
  const [activeNav, setActiveNav] = useState<'controle' | 'compras'>("controle");
                ...
                <Drawer>
                  ...
                  <DrawerContent>
                    <DrawerHeader>
                      ...
                      <DrawerDescription>Converse com sua equipe em tempo real</DrawerDescription>
                    </DrawerHeader>
          ...
          <main className="flex-1 p-6 overflow-auto">
            ...
            <Tabs value={activeNav} className="w-full">
              ...
              <TabsContent value="controle" className="mt-6 space-y-6">
                  ...
                  <CardContent className="p-4">
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 min-w-[180px]">
                        ...
                        <Button variant="outline" size="sm" onClick={() => setIsStorageDrawerOpen(true)}>+ Armazém</Button>
                      </div>
                ...
                <EstoqueTab activeFilter={activeFilter} searchTerm={searchTerm} selectedGalpao={selectedGalpao} />
                <StorageManagementDrawer
                  open={isStorageDrawerOpen}
                  onOpenChange={(open) => setIsStorageDrawerOpen(open)}
                  existingStorage={selectedGalpao !== "todos" ? storageLocations.find(s => s.name === selectedGalpao) : undefined}
                  onSaved={() => {
                    refetchStorage();
                  }}
                />
