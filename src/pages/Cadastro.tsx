...
export default function Cadastro() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Simular cadastro e redirecionar para dashboard
    navigate("/");
  };
        ...
        <Card className="shadow-xl border-0">
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-novura-primary hover:bg-novura-primary/90">
                Criar Conta Grátis
              </Button>
            </form>
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                Já tem uma conta?{" "}
                <Link to="/login" className="text-novura-primary hover:underline font-medium">
                  Fazer login
                </Link>
              </p>
            </div>
