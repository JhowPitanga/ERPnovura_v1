                    ...
                    {Object.values(groupedItems).map((item, itemIndex) => (
                        <li key={itemIndex} className="flex items-start space-x-4 border p-4 rounded-lg bg-gray-50">
                            <div className="w-16 h-16 flex-shrink-0">
                                <img src={item.imagem || "https://via.placeholder.com/64"} alt={item.nome} className="w-full h-full object-cover rounded" />
                            </div>
...
const mockPedidos = [
    { id: "PED001", marketplace: "Mercado Livre", produto: "iPhone 15 Pro Max 256GB", sku: "IPH15PM-256", cliente: "João Silva Santos", valor: 8999.99, data: "2024-01-15", status: "Pendente", tipoEnvio: "ML Envios", idPlataforma: "MLB123456789", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A1", nome: "iPhone 15 Pro Max 256GB", sku: "IPH15PM-256", quantidade: 1, valor: 8999.99, vinculado: true, marketplace: "Mercado Livre" }], financeiro: { valorPedido: 8999.99, taxaFrete: 75.00, taxaMarketplace: 1200.00, cupom: 50.00, impostos: 150.00, liquido: 7674.99, margem: 20 }, impressoEtiqueta: false, impressoLista: false },
    { id: "PED002", marketplace: "Amazon", produto: "MacBook Air M3 16GB 512GB", sku: null, cliente: "Maria Santos Costa", valor: 12999.99, data: "2024-01-15", status: "A vincular", tipoEnvio: "Amazon Prime", idPlataforma: "AMZ987654321", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A2", nome: "MacBook Air M3 16GB 512GB", sku: null, quantidade: 1, valor: 12999.99, vinculado: false, marketplace: "Amazon" }], financeiro: { valorPedido: 12999.99, taxaFrete: 80.00, taxaMarketplace: 1500.00, cupom: 0.00, impostos: 200.00, liquido: 11219.99, margem: 18 }, impressoEtiqueta: false, impressoLista: false },
    { id: "PED003", marketplace: "Shopee", produto: "Samsung Galaxy S24 Ultra", sku: "SGS24U-256", cliente: "Carlos Oliveira", valor: 6999.99, data: "2024-01-14", status: "Emissao NF", tipoEnvio: "Shopee Xpress", idPlataforma: "SHP789123456", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A3", nome: "Samsung Galaxy S24 Ultra", sku: "SGS24U-256", quantidade: 1, valor: 6999.99, vinculado: true, marketplace: "Shopee" }], financeiro: { valorPedido: 6999.99, taxaFrete: 50.00, taxaMarketplace: 900.00, cupom: 20.00, impostos: 100.00, liquido: 5929.99, margem: 22 }, impressoEtiqueta: false, impressoLista: false },
    { id: "PED004", marketplace: "Magazine Luiza", produto: "Nintendo Switch OLED", sku: "NSW-OLED", cliente: "Ana Paula Lima", valor: 2299.99, data: "2024-01-14", status: "NF Emitida", tipoEnvio: "Magalu Entrega", idPlataforma: "MAG456789123", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A4", nome: "Nintendo Switch OLED", sku: "NSW-OLED", quantidade: 1, valor: 2299.99, bipado: false, imagem: "https://via.placeholder.com/50" }], financeiro: { valorPedido: 2299.99, taxaFrete: 30.00, taxaMarketplace: 350.00, cupom: 0.00, impostos: 50.00, liquido: 1869.99, margem: 15 }, impressoEtiqueta: true, impressoLista: true },
    { id: "PED005", marketplace: "Americanas", produto: "iPad Air 5ª Geração", sku: "IPAD-AIR5", cliente: "Roberto Ferreira", valor: 4199.99, data: "2024-01-13", status: "Aguardando Coleta", tipoEnvio: "B2W Entrega", idPlataforma: "AME321654987", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A5", nome: "iPad Air 5ª Geração", sku: "IPAD-AIR5", quantidade: 1, valor: 4199.99, vinculado: true, marketplace: "Americanas" }], financeiro: { valorPedido: 4199.99, taxaFrete: 40.00, taxaMarketplace: 500.00, cupom: 0.00, impostos: 80.00, liquido: 3579.99, margem: 18 }, impressoEtiqueta: true, impressoLista: false },
    { id: "PED006", marketplace: "Shopee", produto: "Fone Bluetooth", sku: "FB-001", cliente: "Mariana Costa", valor: 150.00, data: "2024-01-12", status: "Enviado", tipoEnvio: "Shopee Xpress", idPlataforma: "SHP999888777", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A6", nome: "Fone Bluetooth", sku: "FB-001", quantidade: 1, valor: 150.00, vinculado: true, marketplace: "Shopee" }], financeiro: { valorPedido: 150.00, taxaFrete: 10.00, taxaMarketplace: 20.00, cupom: 0.00, impostos: 5.00, liquido: 115.00, margem: 30 }, impressoEtiqueta: true, impressoLista: true },
    { id: "PED007", marketplace: "Mercado Livre", produto: "Produto Cancelado", sku: "PC-001", cliente: "Cliente Cancelado", valor: 200.00, data: "2024-01-08", status: "Cancelado", tipoEnvio: "ML Envios", idPlataforma: "CAN123456789", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A7", nome: "Produto Cancelado", sku: "PC-001", quantidade: 1, valor: 200.00, vinculado: true, marketplace: "Mercado Livre" }], financeiro: { valorPedido: 200.00, taxaFrete: 0.00, taxaMarketplace: 25.00, cupom: 0.00, impostos: 10.00, liquido: 165.00, margem: 15 }, impressoEtiqueta: false, impressoLista: false },
    { id: "PED008", marketplace: "Mercado Livre", produto: "Smartphone e Fone", sku: null, cliente: "Julia Mendes", valor: 3500.00, data: "2024-01-16", status: "A vincular", tipoEnvio: "ML Envios Flex", idPlataforma: "MLB998877665", quantidadeTotal: 2, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A8", nome: "Smartphone X", sku: null, quantidade: 1, valor: 3000.00, vinculado: false, marketplace: "Mercado Livre" }, { id: "ITEM-A9", nome: "Fone Bluetooth Y", sku: null, quantidade: 1, valor: 500.00, vinculado: false, marketplace: "Mercado Livre" }], financeiro: { valorPedido: 3500.00, taxaFrete: 45.00, taxaMarketplace: 450.00, cupom: 0.00, impostos: 100.00, liquido: 2905.00, margem: 25 }, impressoEtiqueta: false, impressoLista: false },
    { id: "PED009", marketplace: "Shopee", produto: "Produto Com Falha", sku: "FAIL-001", cliente: "Cliente Com Falha", valor: 1000.00, data: "2024-01-16", status: "Emissao NF", subStatus: "Falha na emissao", tipoEnvio: "Shopee Xpress", idPlataforma: "SHP111222333", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A10", nome: "Produto Com Falha", sku: "FAIL-001", quantidade: 1, valor: 1000.00, vinculado: true, marketplace: "Shopee" }], financeiro: { valorPedido: 1000.00, taxaFrete: 15.00, taxaMarketplace: 130.00, cupom: 0.00, impostos: 30.00, liquido: 825.00, margem: 10 }, impressoEtiqueta: false, impressoLista: false },
    { id: "PED010", marketplace: "Amazon", produto: "Produto Com Falha no Envio", sku: "FAIL-002", cliente: "Cliente Com Falha", valor: 1500.00, data: "2024-01-16", status: "Emissao NF", subStatus: "Falha ao enviar", tipoEnvio: "Amazon Prime", idPlataforma: "AMZ111222333", quantidadeTotal: 1, imagem: "https://via.placeholder.com/50", itens: [{ id: "ITEM-A11", nome: "Produto Com Falha no Envio", sku: "FAIL-002", quantidade: 1, valor: 1500.00, vinculado: true, marketplace: "Amazon" }], financeiro: { valorPedido: 1500.00, taxaFrete: 20.00, taxaMarketplace: 180.00, cupom: 0.00, impostos: 40.00, liquido: 1260.00, margem: 12 }, impressoEtiqueta: false, impressoLista: false },
    { id: "PED011", marketplace: "Mercado Livre", produto: "Smartphone e Fone", sku: "SMART-FONE", cliente: "Fernanda Lemos", valor: 3500.00, data: "2024-01-17", status: "NF Emitida", tipoEnvio: "ML Envios", idPlataforma: "MLB1122334455", quantidadeTotal: 2, imagem: "https://via.placeholder.com/50", itens: [
        { id: "ITEM-B1", nome: "Smartphone X", sku: "SMART-X", quantidade: 1, valor: 3000.00, bipado: false, imagem: "https://via.placeholder.com/50" },
        { id: "ITEM-B2", nome: "Fone Bluetooth Y", sku: "FONE-Y", quantidade: 1, valor: 500.00, bipado: false, imagem: "https://via.placeholder.com/50" },
    ...
    { id: "PED012", marketplace: "Mercado Livre", produto: "Câmera e Lente", sku: null, cliente: "Lucas Santos", valor: 5000.00, data: "2024-01-18", status: "Pendente", tipoEnvio: "ML Envios Flex", idPlataforma: "MLB000111222", quantidadeTotal: 2, imagem: "https://via.placeholder.com/50", itens: [
...
function Pedidos() {
    ...
    const [columns, setColumns] = useState([
        { id: "produto", name: "Produto", enabled: true, alwaysVisible: true, render: (pedido) => (
            <div className="flex items-center space-x-3">
                <img src={pedido.imagem} alt={pedido.produto} className="w-10 h-10 rounded-lg object-cover" />
                <div>
                    <div className={`text-sm font-medium text-gray-900 ${pedido.quantidadeTotal > 1 ? 'font-bold' : ''}`}>{pedido.produto}</div>
                    <div className="text-xs text-gray-500">SKU: {pedido.sku || "Não Vinculado"}</div>
                </div>
            </div>
        )},
    ...
    const handleSaveVinculacoes = (vinculos: { [anuncioId: string]: string }) => {
    ...
    return (
        <TooltipProvider>
            <SidebarProvider>
                        ...
                        <main className="flex-1 overflow-auto p-6">
                            ...
                            {activeStatus === "todos" && (
                                <div className="flex items-center space-x-4 mb-6">
                                    ...
                                    <Button variant="outline" className="h-12 px-6 rounded-2xl border-0 bg-white shadow-lg ring-1 ring-gray-200/60" onClick={() => setIsColumnsDrawerOpen(true)}>
                                ...
                                <div className="flex items-center space-x-4 mb-6">
                                    ...
                                    <DropdownMenu>
                                        <DropdownMenuTrigger asChild>
                                            <Button variant="outline" className="h-12 px-6 rounded-2xl bg-white text-gray-800 shadow-lg ring-1 ring-gray-200/60">
                                                <Printer className="w-4 h-4 mr-2" />
                                                Imprimir ({selectedPedidosImpressao.length})
                                                <ChevronDown className="ml-2 h-4 w-4" />
                                            </Button>
                                        </DropdownMenuTrigger>
                                        <DropdownMenuContent>
                                            <DropdownMenuItem onClick={handlePrintPickingList}>
                                            ...
                                            <DropdownMenuSeparator />
                                            <DropdownMenuItem onClick={() => setIsPrintConfigOpen(true)}>
                                                    ...
                                                    <tr key={pedido.id} className="hover:bg-gray-50 transition-colors">
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                            {activeStatus === "a-vincular" ? (
                                                                ...
                                                                <Button variant="outline" className="h-8 w-8 p-0" onClick={(e) => { e.stopPropagation(); handleOpenDetailsDrawer(pedido); }}>
                ...
                <Drawer direction="right" open={isDetailsDrawerOpen} onOpenChange={setIsDetailsDrawerOpen}>
                    <DrawerContent className="w-[35%] right-0">
                        <DrawerHeader className="p-6">
                            <DrawerTitle className="text-xl font-bold">Detalhes do Pedido {selectedPedido?.id}</DrawerTitle>
                            <div className="flex justify-between items-center mt-2">
                                <Badge variant="secondary" className="uppercase">{selectedPedido?.status}</Badge>
                                <div className="text-sm text-gray-500">Data: {selectedPedido?.data}</div>
                            </div>
                        </DrawerHeader>
                        <div className="p-6 flex-1 overflow-y-auto">
                            <section className="mb-6">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm text-gray-700">
                                    <p><strong>ID na Plataforma:</strong> {selectedPedido?.idPlataforma}</p>
                                    <p><strong>Marketplace:</strong> {selectedPedido?.marketplace}</p>
                                    <p><strong>Cliente:</strong> {selectedPedido?.cliente}</p>
                                    <p><strong>Tipo de Envio:</strong> {selectedPedido?.tipoEnvio}</p>
                                </div>
                            </section>

                            {/* --- Nova Seção para Correção de Erros de NF-e --- */}
                            {selectedPedido?.subStatus && (
                                <section className="mb-6 p-4 rounded-lg bg-red-50 border border-red-200">
                                    <div className="flex items-center space-x-2 mb-2">
                                        <X className="h-5 w-5 text-red-600" />
                                        <h3 className="text-lg font-semibold text-red-800">Problemas na Emissão de NF</h3>
                                    </div>
                                    <p className="text-sm text-red-700 mb-4">
                                        Este pedido apresentou o seguinte problema: <strong>{selectedPedido.subStatus}</strong>.
                                    </p>
                                    <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white">
                                        <Bot className="h-4 w-4 mr-2" />
                                        Corrigir com IA
                                    </Button>
                                    <Button variant="ghost" className="w-full mt-2 text-blue-600 hover:text-blue-800" onClick={() => { /* Lógica para criar tarefa no chat */ }}>
                                        Criar Tarefa para Equipe
                                    </Button>
                                </section>
                            )}
                            
                            {/* Restante do Drawer de Detalhes do Pedido */}
                            <section className="mb-6">
                                <h3 className="text-lg font-semibold mb-2">Itens do Pedido ({selectedPedido?.itens?.length})</h3>
                                <div className="space-y-3">
                                    {selectedPedido?.itens?.map((item: any, index: number) => (
                                        <div key={index} className="flex items-center space-x-3 bg-gray-50 p-3 rounded-lg">
                                            <img src={selectedPedido?.imagem} alt={item.nome} className="w-12 h-12 rounded object-cover" />
                                            <div className="flex-1">
                                                <div className="font-medium">{item.nome}</div>
                                                <div className="text-xs text-gray-500">SKU: {item.sku}</div>
                                            </div>
                                            <div>
                                                <Badge variant="outline">{item.quantidade}x</Badge>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <section>
                                ...
                                <ul className="text-sm space-y-2">
                                    <li className="flex justify-between">
                                        ...
                                        <span className="font-medium">R$ {selectedPedido?.financeiro?.valorPedido.toFixed(2)}</span>
                                    </li>
                                    <li className="flex justify-between">
                                        <span className="text-gray-600">Taxa de Frete:</span>
                                        <span className="font-medium text-red-500">- R$ {selectedPedido?.financeiro?.taxaFrete.toFixed(2)}</span>
                                    </li>
                                    <li className="flex justify-between">
                                        <span className="text-gray-600">Taxa Marketplace:</span>
                                        <span className="font-medium text-red-500">- R$ {selectedPedido?.financeiro?.taxaMarketplace.toFixed(2)}</span>
                                    </li>
                                    <li className="flex justify-between">
                                        <span className="text-gray-600">Cupom:</span>
                                        <span className="font-medium text-green-500">+ R$ {selectedPedido?.financeiro?.cupom.toFixed(2)}</span>
                                    </li>
                                    <li className="flex justify-between">
                                        <span className="text-gray-600">Impostos:</span>
                                        <span className="font-medium text-red-500">- R$ {selectedPedido?.financeiro?.impostos.toFixed(2)}</span>
                                    </li>
                                    <li className="flex justify-between border-t mt-2 pt-2 font-bold">
                                        <span>Valor Líquido:</span>
                                        <span>R$ {selectedPedido?.financeiro?.liquido.toFixed(2)}</span>
                                    </li>
                                    <li className="flex justify-between font-bold">
                                        <span>Margem de Lucro:</span>
                                        <span className="text-green-600">{selectedPedido?.financeiro?.margem}%</span>
                                    </li>
                                </ul>
                            </section>
                        </div>
                ...
                {/* Drawer de Colunas */}
                <Drawer direction="right" open={isColumnsDrawerOpen} onOpenChange={setIsColumnsDrawerOpen}>
                    <DrawerContent className="w-[30%] right-0">
                        <DrawerHeader>
