...
import { ArrowLeft, ArrowRight, Check, Package, Layers, Package2 } from "lucide-react";
              ...
              <div>
                ...
                <div className="mt-4">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                    <p className="text-gray-500">Arraste as imagens aqui ou clique para selecionar</p>
                  </div>
                </div>
              </div>
            </div>
