      ...
      <div className="max-w-7xl mx-auto p-8 space-y-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Criar KIT</h1>
              <p className="text-gray-600 text-lg">Configure as informações do seu KIT</p>
            </div>
          </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 mb-8 text-lg">
                    KIT criado com sucesso! Você pode vincular ou criar novos anúncios.
                  </p>
